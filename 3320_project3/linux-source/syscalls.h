...
asmlinkage long sys_print_other(pid_t pid);
asmlinkage long sys_report_mem_stats(int pid);
asmlinkage long sys_report_mem_status(pid_t pid, unsigned long addr);
